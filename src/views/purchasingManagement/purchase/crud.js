  ...
  return {
    rowHandle: {
      ...
      custom: [
        {
          ...
          emit: 'productDetail',
          // disabled: () => {
          //   return !vm.hasPermissions('contract.purchase/detail')
          // }
        },
        {
          text: '对比查看',
          ...
          emit: 'comparison',
          // disabled: () => {
          //   return !vm.hasPermissions('contract.purchase/comparison')
          // }
        },
      ],
      view:{
      ...
      edit: {
        thin: true,
        disabled: () => {
          return !vm.hasPermissions('contract.purchase/edit')
        }
      },
      remove: {
        thin: true,
        disabled: () => {
          return !vm.hasPermissions('contract.purchase/delete')
        }
      },
    },
    pageOptions: {
